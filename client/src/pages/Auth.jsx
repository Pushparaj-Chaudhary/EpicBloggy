                ...
                <div className='flex flex-col items-center justify-center'>
                    <div className='w-full py-4 text-center'>
                        <h1 className='text-3xl font-bold text-gray-800'>
                            {isVerify ? 'Verify Email' : (isLogin ? 'Login' : 'Register')}
                        </h1>
                        <p className='font-light text-gray-500 mt-2'>
                            {isVerify ? 'Enter the OTP sent to your email.' : (isLogin ? 'Welcome back! Please enter your details.' : 'Create an account to submit blogs and comment.')}
                        </p>
                    </div>
                    <form onSubmit={handleSubmit} className='mt-4 w-full text-gray-700'>
                        {isVerify ? (
                        ...
                        <button type='submit' className='w-full py-2.5 font-medium bg-black text-white rounded cursor-pointer hover:bg-black/90 transition-all'>
                            {isVerify ? 'Verify OTP' : (isLogin ? 'Sign In' : 'Sign Up')}
                        </button>
                    </form>
                    {!isVerify ? (
